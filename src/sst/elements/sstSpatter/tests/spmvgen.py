...
cpu0 = sst.Component("cpu0", "sstSpatter.BaseCPU")
cpu1 = sst.Component("cpu1", "sstSpatter.BaseCPU")
cpu_params = {
	"verbose" : 0,
	"clock" : "2GHz",
	"printStats" : 1,
...
gen0 = cpu0.setSubComponent("generator", "sstSpatter.SPMVGenerator")
gen1 = cpu1.setSubComponent("generator", "sstSpatter.SPMVGenerator")
dim = 30
elemSize = 8
ordSize = 4
nnz = 7
